...
<table class="table table-condensed" id = "tabla_modal">
    ...
    <tr>
        <td class="nurse_price">Precio</td>
        <td class="nurse_price"><input class"nurse_price" type="text" id="precio" value=<?php echo $row->PRECIO;?>></td>
    </tr>
    <tr>
        <td class="nurse_sub">Subtotal</td>
        <td class="nurse_sub" id = "sub">$0.00</td>
    </tr>
