<?xml version="1.0" standalone="yes"?>
            <DATAPACKET Version="2.0">
                ...
                <ROWDATA>
                    <ROW RowState="4" CVE_CLPV="         4" NUM_ALMA="1" CVE_PEDI="330" ESQUEMA="1" DES_TOT="0" DES_FIN="0" CVE_VEND="" COM_TOT="0" NUM_MONED="1" TIPCAMB="1" STR_OBS="" MODULO="FACT" CONDICION="">
                        <dtfield></dtfield>                    
                    </ROW>
                </ROWDATA>
            </DATAPACKET>