<?php  
    ...
    switch($accion){        
        ...
        default:
            ...
            $sql = $pdo->prepare("SELECT id,CONCAT(title,'--',servicio) as title,doctor,doctor_asignado,enfermera,start,end,materiales,duracion,estatus,servicio,cubiculo,color,razon_social from citas WHERE estatus = 'Terminada' and doctor like '$nombre'");
            $sql -> execute();
